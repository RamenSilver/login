...
class WaitingSvg extends React.Component {

  render() {
    return(
      <div className="loader-wrap">
        <div className="bottle-wrap">
          <div className="cap"><i></i><i></i><i></i><i></i></div>
          <div className="bottle">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="26.81px" height="106.124px" viewBox="0 0.5 26.81 106.124" enableBackground="new 0 0.5 26.81 106.124" xmlSpace="preserve">
              <defs>
            ...
            c0,0,5.515-0.765,5.515-5.515s0-30.75,0-45.47S17.905,38.109,17.905,38.109z" />
                <mask id="bottle_mask">
                  <use x="0" y="0" xlinkHref="#bottle" opacity="1" fill="#ffffff" />
                </mask>
              </defs>
              <rect className="bottle-fill" mask="url(#bottle_mask)" fill="url(#water_fill)" x="-400" y="0" width="1600" height="120" />
              <path id="btl-out" fill="none" stroke="#FCE480" strokeWidth="3" strokeMiterlimit="10" d="M17.905,38.109V9.734
          ...
          <div className="bottle">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="32.339px" height="105.586px" viewBox="0 0 32.339 105.586" enableBackground="new 0 0 32.339 105.586" xmlSpace="preserve">
              <defs>
                <pattern id="water_fill" width=".25" height="1.1" patternContentUnits="objectBoundingBox">
                  <path fill="#FBCE13" d="M0.25,1H0c0,0,0-0.659,0-0.916c0.083-0.303,0.158,0.334,0.25,0C0.25,0.327,0.25,1,0.25,1z" />
                </pattern>
            ...
            C29.003,82.919,30.919,51.503,30.836,48.086z" />
                <mask id="bottle_mask_2">
                  <use x="0" y="0" xlinkHref="#bottle_2" opacity="1" fill="#ffffff" />
                </mask>
              </defs>
              <rect className="bottle-fill" mask="url(#bottle_mask_2)" fill="url(#water_fill)" x="-400" y="0" width="1600" height="120" />
              <path id="btl-out" fill="none" stroke="#FCE480" strokeWidth="3" strokeMiterlimit="10" d="M30.836,48.086
          ...
          <div className="bottle">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="31.314px" height="102.629px" viewBox="0 0 31.314 102.629" enableBackground="new 0 0 31.314 102.629" xmlSpace="preserve">
              <defs>
                <pattern id="water_fill" width=".25" height="1.1" patternContentUnits="objectBoundingBox">
                  <path fill="#FBCE13" d="M0.25,1H0c0,0,0-0.659,0-0.916c0.083-0.303,0.158,0.334,0.25,0C0.25,0.327,0.25,1,0.25,1z" />
                </pattern>
            ...
            S31.157,64.254,29.157,53.497z" />
                <mask id="bottle_mask_3">
                  <use x="0" y="0" xlinkHref="#bottle_3" opacity="1" fill="#ffffff" />
                </mask>
              </defs>
              <rect className="bottle-fill" mask="url(#bottle_mask_3)" fill="url(#water_fill)" x="-400" y="0" width="1600" height="120" />
              <path id="btl-out" fill="none" stroke="#FCE480" strokeWidth="3" strokeMiterlimit="10" d="M29.157,53.497c-2-10.757-6.688-36.18-7.375-40.493
          ...
          <div className="bottle">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="27.071px" height="100.378px" viewBox="0 0 27.071 100.378" enableBackground="new 0 0 27.071 100.378" xmlSpace="preserve">
              <defs>
                <pattern id="water_fill" width=".25" height="1.1" patternContentUnits="objectBoundingBox">
                  <path fill="#FBCE13" d="M0.25,1H0c0,0,0-0.659,0-0.916c0.083-0.303,0.158,0.334,0.25,0C0.25,0.327,0.25,1,0.25,1z" />
                </pattern>
            ...
            c1.625,0,4.971,0,8,0c4.188,0,3.75-8.625,2.813-14S26.038,52.878,25.474,44.253z" />
                <mask id="bottle_mask_4">
                  <use x="0" y="0" xlinkHref="#bottle_4" opacity="1" fill="#ffffff" />
                </mask>
              </defs>
              <rect className="bottle-fill" mask="url(#bottle_mask_4)" fill="url(#water_fill)" x="-400" y="0" width="1600" height="120" />
              <path id="btl-out" fill="none" stroke="#FCE480" strokeWidth="3" strokeMiterlimit="10" d="M25.474,44.253c-0.564-8.625-3.189-12-5.189-20
